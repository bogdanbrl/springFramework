...
import com.bogdan.springdemo.service.RandomizerRequestScope;
import com.bogdan.springdemo.service.RandomizerSessionScope;
...
public class ScopeController {
	...
	public void getRandom(HttpServletResponse response) throws Exception{
		...
		response.getWriter().write("<br>******************* session scope *******************<br>");
