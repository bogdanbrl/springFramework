...
public class Organization {
	...
	//add property using @Value from organization.properties (resources folder)
...
//	Add them in beans-cp.xml file
	...
	//add property using  setter method with @Value from organization.properties (resources folder). Need to add @Autowired
	@Autowired
