	...
	<div align="center">
		...
		<form:form action="registerOrg" modelAttribute="orgRegistration">
			<table>
				...
				<tr>
					<td><form:label path="optionalServices">Optional Services Subsriptions:</form:label></td>
					<td>
				...
				<tr>
					<td><form:label path="employeeStrength">Workforce Size (Employee Strength): </form:label></td>
