package com.criptex.springdemo.config;
...
import com.criptex.springdemo.interceptors.ExecutionTimerInterceptor;
import com.criptex.springdemo.interceptors.HeaderInterceptor;
import com.criptex.springdemo.interceptors.VisitorInterceptor;

@Configuration
@ComponentScan("com.criptex.springdemo")
@EnableWebMvc
