...
public class TodoData {
    ...
    public List<TodoItem> getItems() {
        return Collections.unmodifiableList(items);         // unmodifiableList -- imutable list from outside class
    }

    public void addItem(@NonNull TodoItem toAdd){

        // check if the entry is null or you can use lombok for this operation @NonNull
//        if(toAdd == null){
